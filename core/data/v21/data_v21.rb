module PokeAccess
  ...
  module DataV21
    ...
    def self.ability_description(id); a = GameData::Ability.try_get(id); a && a.description; end
    def self.nature_name(id);      GameData::Nature.get(id).name; end
    # Trainer TYPE, not a trainer: the kind of person a sprite depicts ("Youngster", "Nurse").
    def self.trainer_type_name(id); t = GameData::TrainerType.try_get(id); t && t.name; end

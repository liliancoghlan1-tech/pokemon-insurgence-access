module PokeAccess
  ...
  module Config
    SCHEMA = [
      ...
      [:walkthrough,          true,  :flag, :general,    :lbl_walkthrough,      :help_walkthrough],
      [:auto_detect,          true,  :flag, :general,    :lbl_auto_detect,      :help_auto_detect],
      [:read_help,            true,  :flag, :general,    :lbl_read_help,        :help_read_help],
      [:unseen_on_arrival,   false, :flag, :general,    :lbl_unseen_arrival,   :help_unseen_arrival],
      [:announce_day_night,  true,  :flag, :general,    :lbl_day_night,        :help_day_night],
      [:dialogue_pages,       true,  :flag, :general,    :lbl_dialogue_pages,   :help_dialogue_pages],
      ...
      [:assist_encounters,   :normal, :encmode, :assist, :lbl_assist_enc,      :help_assist_enc],
      [:assist_exp,          :normal, :expmode, :assist, :lbl_assist_exp,      :help_assist_exp],
      [:assist_expshare,     false,   :flag,    :assist, :lbl_assist_expshare, :help_assist_expshare]
    ]
